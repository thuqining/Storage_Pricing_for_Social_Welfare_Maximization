...
%@File    : MultiPeriod_ED_CC_withoutreserve.m
...
% storage: energy market

function [obj_value,energy_price,storage_price,reserve_price,SOC_value,rho_g_value,Pdis_value,Pch_value,Pg_value,Dch_value,Ddis_value]=MultiPeriod_ED_CC_withoutreserve(a,b,c,d,e,f,g)
%% inputs
